...
delta_last = -(softmaxTheta' * difference).* sigmoidGradient(z_4); %10(parameters)x11
delta_3 = (softmaxTheta'*delta_last).*sigmoidGradient(z_3); %20x11
